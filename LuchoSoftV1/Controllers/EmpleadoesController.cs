...
namespace LuchoSoftV1.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(LuchoSoftContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empleados != null ? 
                          ...
                          Problem("Entity set 'LuchoSoftContext.Empleados'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LuchoSoftContext.Empleados'  is null.");
            }
            var empleado = await _context.Empleados.FindAsync(id);
            if (empleado != null)
            {
