...
namespace LuchoSoftV1.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(LuchoSoftContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'LuchoSoftContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LuchoSoftContext.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
